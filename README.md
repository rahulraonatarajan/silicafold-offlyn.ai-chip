...
**This is the actual physical layout** generated by the Tiny Tapeout/OpenLane flow:
...
| **Regular grid** | Standard cells (AND, OR, flip-flops, buffers) |
| **Die boundary** | 4×2 Tiny Tapeout tiles = ~682 × 226 µm |
...
| Artifact | Contents |
|----------|----------|
| `tt_submission` | GDS, LEF, Verilog for Tiny Tapeout |
| `gds_render` | PNG render (shown above) |
| `precheck_reports` | DRC, LVS, and other verification reports |

### Concept Image vs Actual GDS

Any architecture diagram in this README (other than the GDS render above) is a **conceptual visualization**. The GDS render above is the actual physical layout generated from the OpenLane flow.
